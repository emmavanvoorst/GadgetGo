...
import AboutBanner from "../IMGs/About.jpg";
import Jasmine from "../IMGs/jasmine.png";
import Gabriel from "../IMGs/gab.jpg";
import Nishteman from "../IMGs/nishteman.jpg";
...
const AboutPage = () => {
  return (
    <Container>
      ...
      <TeamBox>
        <NavLinks target="#"  to="https://portfolio-website-jasmineplqn.vercel.app/">
          <Box>
